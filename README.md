...
Openfire 4.3 and later use Log4j 2, which uses a new configuration file. Please make sure you include a `log4j2.xml` file in your configuration directory, and use the newest 4.3, 4.4 or 4.5.1 image available on Docker Hub.
...
```bash
docker pull gizmotronic/openfire:4.5.1
```
